...
import work.kozh.ioc.model.AnnotatedClass;
import work.kozh.ioc.model.BindViewField;
import work.kozh.ioc.model.OnClickMethod;
...
public class ViewInjectProcesser extends AbstractProcessor {
    ...
    public Set<String> getSupportedAnnotationTypes() {
        ...
        types.add(InjectView2.class.getCanonicalName());
        types.add(ViewClick2.class.getCanonicalName());
        return types;
    }
    ...
    private void processBindView(RoundEnvironment roundEnv) throws IllegalArgumentException {
        for (Element element : roundEnv.getElementsAnnotatedWith(InjectView2.class)) {
    ...
    private void processOnClick(RoundEnvironment roundEnv) {
        for (Element element : roundEnv.getElementsAnnotatedWith(ViewClick2.class)) {
            AnnotatedClass annotatedClass = getAnnotatedClass(element);
